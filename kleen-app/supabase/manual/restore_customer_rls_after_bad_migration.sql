-- =============================================================================
-- EMERGENCY: Restore customer read access after a bad migration (e.g. 037).
-- =============================================================================
--
-- HOW TO RUN (avoids browser CSP / inline-script issues):
--   1. Open Supabase Dashboard → SQL Editor (project: your production/staging DB).
--   2. Paste this ENTIRE file.
--   3. Click "Run" once. Do not use bookmarklets or extensions that inject JS.
--
-- This is the same logic as migration 039_force_restore_customer_rls.sql.
-- It DROP + CREATEs policies so broken definitions are replaced (038 only added
-- missing policies by name and would not replace a corrupted policy).
-- =============================================================================
