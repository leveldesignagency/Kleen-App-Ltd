-- Run in Supabase SQL editor if contractor "Add service" is missing catalogue entries.
-- Idempotent — safe to run multiple times. Same as migration 045_sync_services_catalog.sql.
