      ...
      <MarketingPageSection>
        <div className={`mx-auto max-w-3xl ${marketingCard}`}>
          ...
          <div className="prose mt-8 max-w-none text-slate-600 [&_h2]:mt-8 [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-slate-900 [&_p]:mt-3 [&_p]:leading-relaxed [&_ul]:mt-3 [&_ul]:list-disc [&_ul]:pl-5 [&_li]:mt-1">
            ...
            <p>
              We share relevant job details with assigned cleaning professionals. We do not sell
              your personal data to third parties. We may share data with service providers who help
              us operate the platform (e.g., payment processors, hosting providers).
            </p>

            <h2>4. Data Security</h2>
            <p>
              We implement industry-standard security measures to protect your data, including
              encryption in transit and at rest. Payment data is handled by PCI-compliant processors.
            </p>

            <h2>5. Your Rights</h2>
            <p>
              Under GDPR, you have the right to access, correct, delete, or export your personal
              data. Contact us at privacy@kleen.co.uk to exercise these rights.
            </p>
